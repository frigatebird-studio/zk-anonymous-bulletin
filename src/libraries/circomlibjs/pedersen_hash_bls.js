...
export default async function buildPedersenHashBls() {
    const babyJub = await buildBabyJubBls();
    return new PedersenHashBls(babyJub);
}

class PedersenHashBls {
